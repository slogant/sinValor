 ...
 * @author oscar
 */
final public class EscuchaPuerto implements SerialPortEventListener {
    
    public EscuchaPuerto(JTextField texto, JButton boton, JComboBox<String> elcombox) {
        text = texto;
        btns = boton;
        comb = elcombox;
    }
        ...
        if (puertox.isBlank()) {
            ...
            try {
                ...
                if (!elPuerto.isOpened()) {
                    elPuerto.openPort();//Abre el puerto seria
